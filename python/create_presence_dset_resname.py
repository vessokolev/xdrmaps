...
#           atoms that belong to a certain residue name.
...
def select_atoms_solvent(gro_file):
   ...
   with open(gro_file,'r') as file_obj:
      ...
      for line in file_obj:
         ...
         if counter==1:
            ...
            # array will be set 1).
            atom_presence=[0 for i in range(numatoms)]
         else:
            if counter>1:
...
if flag:
   ...
   atom_presence=select_atoms_solvent(sys.argv[1])
