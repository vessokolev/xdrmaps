      ...
      subroutine read_real_vector_set(h5_file,&
                                     dsetname,&
                                     vect)
      !
      ...
      ! Open the HDF5 file:
      !
      call h5fopen_f(trim(adjustl(h5_file)),&
                     H5F_ACC_RDWR_F,&
                     file_id,&
                     error)
      if (error.ne.0) then
      ...
      !
      call h5sget_simple_extent_ndims_f(dataspace,&
                                        rankr,&
                                        error)
      if (error.ne.0) then
         print *
      ...
      !
      call h5sget_simple_extent_dims_f(dataspace,&
                                       dims,&
                                       max_dims,&
                                       error)
      !
      ...
      subroutine read_int_vector_set(h5_file,&
                                     dsetname,&
                                     vect)
      !
      ...
      subroutine read_scalar_set(h5_file,&
                                 dsetname,&
                                 val)
      !
      ...
      subroutine read_freq_grid(h5_file,&
                                dsetname,&
                                grid)
      !
      ...
      subroutine get_mass_slice(grid_s,&
                                grid,&
                                sel_dim,&
                                current_node,&
                                slice_width,&
      ...
      subroutine get_vf_slice(grid_s,&
                              grid,&
                              freq,&
                              sel_dim,&
                              current_node,&
      ...
      function get_slice_shape(array_s,&
                               sel_dim) result(res)
      !
      ...
      subroutine float_to_string(float_num,&
                                 fmt_str,&
                                 str_len,&
                                 str)
      !
      ...
      subroutine write_map_file(output_folder,&
                                map_file_prefix,&
                                map_number,&
                                slice_s,&
                                slice,&
      ...
      real(C_FLOAT),dimension(2),intent(in) :: step
      !
      ! Local variables:
      !
